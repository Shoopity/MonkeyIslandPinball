...
Sub SuperVukAddBallLeChuck(dir)
	If BallInHole1> 0 Then
        BallInHole1 = BallInHole1 - 1
		'Create a sized ball with the correct ID
		Kicker003.CreateSizedball(BallSize / 2).ID = LeChuckBallID
		'ChangeBallImage
'		kickoutkick2
		kickoutkick2(dir)
		vpmtimer.addtimer 1000, "SuperVukAddBallLeChuck(dir) '" 
	end If
End Sub

'You don't need this sub anymore
'Sub SuperVukAddBall2()
'	If BallInHole1> 0 Then
'		BallInHole1 = BallInHole1 - 1
'		Kicker003.CreateSizedball(BallSize / 2).ID = LeChecukBallID
		'ChangeBallImage
'		kickoutkick3
...
sub kickoutkick2(dir)
	Playsound "fx_popper"
	Kicker003.Kick dir, 7, 14
end sub

'You don't need this sub anymore either
'sub kickoutkick3
'	Playsound "fx_popper"
...
Sub SuperVukAddBall3()
	If BallInHole2 > 0 Then
        BallInHole2 = BallInHole2 - 1
		Kicker006.CreateSizedball(BallSize / 2).ID = BarBallID
		'ChangeBallImage
		barkickout
...
Sub SuperVukAddBall4()
	If BallInHole3 > 0 Then
        BallInHole3 = BallInHole3 - 1
		Kicker005.CreateSizedball(BallSize / 2).ID = VoodooBallID
		'ChangeBallImage
		voodookickout
...
Sub SuperVukAddBall5()
	If BallInHole2> 0 Then
		...
		vpmtimer.addtimer 1000, "kickrightbelow '"
...
sub kickrightbelow
	Playsound "fx_popper"
	Kicker002.CreateSizedball(BallSize / 2).ID = VoodooBallID
	Kicker002.Kick 280, 7, 14
	If BallInHole2 = 0 Then vpmtimer.addtimer 1100, "resettarget13 '"
end sub
...
'        Case 1:SuperVukAddBall2
		'You only need one SuperVukAddBall, just pass a variable for the direction to kick out
		Case 0:SuperVukAddBallLeChuck(270)
		Case 1:SuperVukAddBallLeChuck(90)
    End Select
End Sub
